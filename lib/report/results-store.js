...
module.exports = resultsStore = {
  ...
  isPassing: function () {
    return !_.some(store.all('results'), function (result) {
      return !result.passing
    })
  },
  currentTestHasFailed: function () {
    return current().passing === false
...
function createResult (metadata) {
  var result = set(metadata, _.assignIn(omit(metadata, 'callable'), {
    passing: true,
    setUpFailed: false,
    errors: [],
    children: [],
