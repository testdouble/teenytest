...
module.exports = function (testLocators, userOptions) {
  ...
  var testCriteria = _.map(testLocators, function (testLocator) {
  ...
  testCriteria = _.map(testCriteria, function (globCriterion) {
    return applyNameFilters(globCriterion, userOptions.example)
  })
  ...
  testCriteria = _.flatMap(testCriteria, function (globCriterion) {
...
function consolidatedPathCriteria (testCriteria) {
