...
var actionsForTestFunctions = function (test, ancestors, helper, stats) {
  ...
  var testDescription = test.description(stats.suiteCount, stats.fileCounts[test.file])
  ...
  var testActions = {
    ...
    successHandler: function (log) {
      log('ok ' + testDescription)
    },
    failureHandler: function (log) {
      log('not ok ' + testDescription)
    },
    callable: function (cb) {
...
var actionForHook = function (helperFunc, name, context, file) {
  var action = {
    ...
    isAssociatedWithATest: context != void 0
  }
