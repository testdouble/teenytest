...
module.exports = function (testGlob, userOptions, cb) {
  ...
  var userActions = userActionsFactory(options)
  var passed = true
  ...
  var testSuiteActions = [
    ...
    function (cb) {
      var testModuleActions = _(testModules).map(function (testModule, testModuleIndex) {
        ...
        var testModuleErrorLogger = function (e, action) {
          if (e) {
        ...
        return [
          ...
          function (cb) {
            var testFunctionActions = _(testModule.tests).map(function (test, i) {
              ...
              var testFunctionErrorLogger = function (e, action) {
                if (e) {
...
var addHookDescription = function (hookType, testOrModule, index) {
